  ...
  >
    ...
    <div class="block-button">
      <div class="button-group">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="#269EB7"  viewBox="0 0 16 16">
...
<script setup>
  ...
  function deleteVisibleConfirm(){
    confirm.setConfirmMessage("Вы, действительно хотите удалить вопрос?")
    let timerId = setInterval(() => {
      if (confirm.getConfirmAction) {
        clearInterval(timerId)
        if (confirm.getConfirmAction === "yes" ){deleteQuestin()}
      }
    }, 200);
  }
