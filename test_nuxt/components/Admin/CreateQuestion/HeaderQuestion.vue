...
export default {
  ...
  created(){
    if (this.operationEdit){
      this.typeQuestion = this.questions.getQuestion.type.title
      this.questionTitle = this.questions.getQuestion.title ? this.questions.getQuestion.title : ''
      this.questionImgUrl = this.questions.getQuestion.image ? this.questions.getQuestion.image : ''
      this.questionShuffleVariants = this.questions.getQuestion.shuffleVariants
