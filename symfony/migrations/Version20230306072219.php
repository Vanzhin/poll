 ...
 */
final class Version20230306072219 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question ADD author_id INT DEFAULT NULL, ADD published_at DATE DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question DROP author_id, DROP published_at');
    }
}
