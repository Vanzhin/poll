...
class CreateAction extends NewBaseAction
{
    ...
    public function run(Request $request, User $owner): JsonResponse
    {
        ...
        $group = $this->factory->createBuilder()->build($data, $owner);
        ...
        return $this->successResponse($group, ['admin_group'], 'Группа создана.');
    }
}