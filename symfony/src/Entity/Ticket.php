...
class Ticket
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['main', 'main_test', 'category', 'admin_section', 'admin_ticket', 'admin_question', 'test', 'breadcrumbs'])]
    private ?int $id = null;
    ...
    #[Groups(['main', 'main_test', 'account', 'admin', 'category', 'admin_section', 'admin_ticket', 'admin_question', 'result', 'test', 'breadcrumbs'])]
